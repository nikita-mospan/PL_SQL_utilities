CREATE OR REPLACE PACKAGE BODY pk_validate AS
	...
	procedure do_validate (p_validated_table_in varchar2
        ...
        v_ins_rule_violation_templ varchar2(32767) := ' when ($RULE_CODE is not null) then into ' || p_val_error_table_s_in ||
    ...
    begin
        ...
        pk_util_log.log_and_execute_ddl(p_action_name_in => 'Truncate ' || p_val_error_table_s_in
                                        , p_sql_in => 'truncate table ' || p_val_error_table_s_in);
        ...
        pk_util_log.log_and_execute_dml(p_action_name_in => 'Populate ' || p_val_error_table_s_in, 
        ...
        pk_etl.load_master_table(p_master_table_in => p_val_error_table_m_in, 
                            p_mapping_name_in => p_val_error_mapping_name_in, 
