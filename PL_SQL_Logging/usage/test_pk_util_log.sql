begin
    ...
    pk_util_log.open_next_level(p_comments_in => 'Hi guys');
    pk_util_log.open_next_level(p_comments_in => 'Once again');
    pk_util_log.open_next_level(p_comments_in => 'And again');
